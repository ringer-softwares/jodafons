...
def create_model( c1, c2, d1, kernel_size=2, use_l2=False ):
    # expect an input with 50 dimensions (features)
    input = layers.Input(shape=(50,), name = 'Input') # 0
    input_reshape = layers.Reshape((50,1), name='Reshape_layer')(input)
...
create_jobs( models        = models,
             ...
             nSortsPerJob  = 1,
             nModelsPerJob = 1,
             outputFolder  = 'job_config.Zee_v14.10sorts.5inits',
             )
