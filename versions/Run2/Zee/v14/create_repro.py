...
# exec this
exec_cmd+= "python jodafons/versions/Run2/Zee/v14/job_reprocess.py -t %IN -d %DATA -r %REF -v %OUT"
exec_cmd+= " && rm -rf jodafons"

command = """maestro.py task create \
  -v {PATH} \
  -t user.jodafons.data17_13TeV.AllPeriods.sgn.probes_lhmedium_EGAM1.bkg.VProbes_EGAM7.GRL_v97.v14.25bins_et{ET}_eta{ETA}.r1 \
  -c user.jodafons.data17_13TeV.AllPeriods.sgn.probes_lhmedium_EGAM1.bkg.VProbes_EGAM7.GRL_v97.v14.25bins_et{ET}_eta{ETA}.r0 \
