...
exec_cmd+= " --pr /home/jodafons/public/tuning_data/tasks/Zee/v10/user.jodafons.data17_13TeV.AllPeriods.sgn.probes_lhmedium_EGAM1.bkg.VProbes_EGAM7.GRL_v97.v10.25bins_et{ET}_eta{ETA}.r0"
command = """maestro.py task create \
  -v {PATH} \
  -t user.jodafons.data17_13TeV.AllPeriods.sgn.probes_lhmedium_EGAM1.bkg.VProbes_EGAM7.GRL_v97.v11.25bins_et{ET}_eta{ETA}.r0 \
