...
# exec this
exec_cmd+= "python jodafons/versions/Run2/Zee/v11/job_reprocess.py -t %IN -d %DATA -r %REF -v %OUT"
...
command = """maestro.py task create \
  ...
  -d user.jodafons.data17_13TeV.AllPeriods.sgn.probes_lhvloose_EGAM1.bkg.vprobes_vlhvloose_EGAM7.GRL_v+97.25bins_et{ET}_eta{ETA}.h5 \
  --sd "{REF}" \
  --exec "{EXEC}" \
  --queue "gpu" \
  --bypass_local_test \
