...
path = basepath + '/Zee/v9_ss'

# from...
exec_cmd = "git clone https://github.com/ringer-softwares/jodafons.git && "
# exec this
exec_cmd+= "python jodafons/versions/Run2/Zee/v9/v9_ss/job_reprocess.py -t %IN -d %DATA -r %REF -v %OUT"
exec_cmd+= " && rm -rf jodafons"

command = """maestro.py task create \
  -v {PATH} \
  -t user.jodafons.data17_13TeV.AllPeriods.sgn.probes_lhmedium_EGAM1.bkg.VProbes_EGAM7.GRL_v97.v9_ss.25bins_et{ET}_eta{ETA}.r1 \
  -c user.jodafons.data17_13TeV.AllPeriods.sgn.probes_lhmedium_EGAM1.bkg.VProbes_EGAM7.GRL_v97.v9_ss.25bins_et{ET}_eta{ETA}.r0 \
