...
path = basepath + '/Zee_el/v1/v1_trk'

# from...
exec_cmd = "git clone https://github.com/ringer-softwares/jodafons.git && "
# exec this
exec_cmd+= "python jodafons/versions/Run2/Zee_el/v1/v1_trk/job_tuning.py -c %IN -d %DATA -r %REF -v %OUT"

command = """maestro.py task create \
  -v {PATH} \
  -t user.jodafons.data17_13TeV.AllPeriods.sgn.probes_lhmedium_EGAM1.bkg.VProbes_EGAM7.GRL_v97.v1_trk_el.25bins_et{ET}_eta{ETA}.r0 \
  -c user.jodafons.job_config.Zee_v1_trk_el.10sorts.5inits \
