...
path = basepath + '/Jpsi/v1'

# from...
exec_cmd = "git clone https://github.com/ringer-softwares/jodafons.git && "
# exec this
exec_cmd+= "python jodafons/versions/Run2/Jpsi/v1/job_reprocess.py -t %IN -d %DATA -r %REF -v %OUT"
exec_cmd+= " && rm -rf jodafons"

command = """maestro.py task create \
  -v {PATH} \
  -t user.jodafons.data17_13TeV.AllPeriods.sgn.probes_lhmedium_EGAM2.bkg.VProbes_EGAM7.GRL_v97.v1.15bins_et{ET}_eta{ETA}.r1 \
  -c user.jodafons.data17_13TeV.AllPeriods.sgn.probes_lhmedium_EGAM2.bkg.VProbes_EGAM7.GRL_v97.v1.15bins_et{ET}_eta{ETA}.r0 \
