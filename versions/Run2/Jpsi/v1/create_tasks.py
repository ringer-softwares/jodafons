...
# exec this
exec_cmd+= "python jodafons/versions/Run2/Jpsi/v1/job_tuning.py -c %IN -d %DATA -r %REF -v %OUT"

# NOTE: we set all probes to medium working point

command = """maestro.py task create \
  -v {PATH} \
  -t user.jodafons.data17_13TeV.AllPeriods.sgn.probes_lhmedium_EGAM2.bkg.VProbes_EGAM7.GRL_v97.v1.15bins_et{ET}_eta{ETA}.r0 \
  -c user.jodafons.job_config.Jpsi_v1.n2to5.10sorts.5inits \
