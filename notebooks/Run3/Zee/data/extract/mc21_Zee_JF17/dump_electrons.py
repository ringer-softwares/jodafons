...
parser.add_argument('--is_zee', action='store_true',
    dest='is_zee', required = False, 
    help = "is jpsi decay.")
...
class MyFilter:
    def __init__ ( self, etmin, etmax, is_zee, ps_cut =1):
        self.etmin = etmin
        self.etmax = etmax
        self.is_zee=is_zee
        self.ps_cut=ps_cut
...
my_filter = MyFilter(args.et_min, args.et_max, args.is_zee, ps_cut=0.5)
...
dumper = ElectronDumper(output, et_bins, eta_bins, target=args.target_label, dumpRings=True, etbins_range=[3,7] )
