...
#SBATCH --cpus-per-task=40   	# Numero de threads por tarefa
#SBATCH --partition=cpu      	# Fila (partition) a ser utilizada
...
srun -N 1 -n 1 -c $SLURM_CPUS_PER_TASK singularity run --nv --writable-tmpfs $IMG pilot run --master &
